...
//!
//! Uses the `EditablePackage` from office_core to preserve all parts,
//! modifying individual cells in worksheet XML.

use office_core::editable::EditablePackage;
use office_core::opc::PartName;
...
impl EditableXlsx {
    ...
    pub fn set_cell(
        ...
        let Some(data) = self.package.get_part(&part_name) else {
            return Err(crate::XlsxError::Core(office_core::Error::MissingPart(
