...
fn markdown_paragraph(para: &crate::shape::TextParagraph) -> String {
...
fn markdown_run(run: &crate::shape::TextRun) -> String {
...
mod tests {
    ...
    use crate::PptxDocument;
    use crate::presentation::PresentationInfo;
