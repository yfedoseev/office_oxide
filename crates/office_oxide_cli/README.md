...
Powered by [office_oxide](https://crates.io/crates/office_oxide) — the fastest Office document processing library in Rust. 98.3% pass rate on a 5,146-file corpus.
