use crate::document::BlockElement;
use crate::hyperlink::HyperlinkTarget;
use crate::image::DrawingInfo;
use crate::numbering::NumberingDefinitions;
use crate::paragraph::{BreakType, ParagraphContent, Run, RunContent};
        ...
        match elem {
            BlockElement::Paragraph(p) => {
                ...
                let list_prefix = p.properties.as_ref().and_then(|pp| {
                    ...
                    use crate::numbering::NumberFormat;
