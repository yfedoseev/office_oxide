...
98.4% pass rate on 6,062 real-world Office files. MIT / Apache-2.0 licensed.
...
**Go** + **Rust core** | MIT / Apache-2.0 | 98.4% pass rate on 6,062 files | Up to 100× faster than alternatives | 6 formats
